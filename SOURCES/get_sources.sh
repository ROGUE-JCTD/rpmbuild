...
srcs+=("https://s3.amazonaws.com/boundlessps-public/geoshape/src/proj-4.9.2.tar.gz")
srcs+=("https://s3.amazonaws.com/boundlessps-public/geoshape/src/proj-datumgrid-1.5.tar.gz")
